...
/* harmony default export */ __webpack_exports__["default"] = (_components$data$prop = {
  components: {
...
}, _defineProperty(_components$data$prop, "data", function data() {
  return {
    preview: null,
    photo: null
  };
  ...
  onFileChange: function onFileChange(event) {
    ...
    reader.readAsDataURL(event.target.files[0]); // photo にファイルを代入

    this.photo = event.target.files[0];
  },
  reset: function reset() {
    this.preview = '';
    this.photo = null; // this.$el はコンポーネントそのものの DOM 要素を指す
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  // ログインページを表示するタイミング created ライフサイクルフックでエラーをクリア
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(context, data) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              context.commit('setApiStatus', null); // API 通信が成功した場合も失敗した場合も response にレスポンスオブジェクトを代入
...
module.exports = __webpack_require__(/*! /var/www/html/photo-share/resources/js/app.js */"./resources/js/app.js");
